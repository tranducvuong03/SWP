...
namespace C_ {
    ...
    public partial class TestDataSet1 : global::System.Data.DataSet {
        ...
        public partial class ImagesDataTable : global::System.Data.TypedTableBase<ImagesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ImagesRow AddImagesRow(int Id, string ImageName, byte[] Image, string ImageUrl) {
...
namespace C_.TestDataSet1TableAdapters {
    ...
    public partial class ImagesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Images] ([Id], [ImageName], [Image], [ImageUrl]) VALUES (@Id, " +
                "@ImageName, @Image, @ImageUrl);\r\nSELECT Id, ImageName, Image, ImageUrl FROM Imag" +
                "es WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Images] SET [Id] = @Id, [ImageName] = @ImageName, [Image] = @Image," +
                " [ImageUrl] = @ImageUrl WHERE (([Id] = @Original_Id));\r\nSELECT Id, ImageName, Im" +
                "age, ImageUrl FROM Images WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::C_.Properties.Settings.Default.TestConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, ImageName, Image, ImageUrl FROM dbo.Images";
        ...
        public virtual int Fill(TestDataSet1.ImagesDataTable dataTable) {
        ...
        public virtual TestDataSet1.ImagesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TestDataSet1.ImagesDataTable dataTable = new TestDataSet1.ImagesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TestDataSet1.ImagesDataTable dataTable) {
        ...
        public virtual int Insert(int Id, string ImageName, byte[] Image, string ImageUrl) {
        ...
        public virtual int Update(int Id, string ImageName, byte[] Image, string ImageUrl, int Original_Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ImageName, byte[] Image, string ImageUrl, int Original_Id) {
            return this.Update(Original_Id, ImageName, Image, ImageUrl, Original_Id);
        }
    }
